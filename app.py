    ...
    if request.method == 'POST':
        ...
        # 세네카 계산 폼 제출 처리
            ...
            return render_template('index.html', 
                                   ...
                                   # 검색 결과 및 키워드 등은 POST 요청 시 다시 로드되지 않으므로 초기화
                                   results=[], keyword="", message="", logo_path=image_file_name,
                                   current_sort_by=None, current_sort_order=None)
